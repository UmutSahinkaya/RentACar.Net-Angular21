...
/// <inheritdoc />
public partial class i_added_protection_package_table : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_ProtectionPackages", x => x.Id);
            });
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                _ = table.PrimaryKey("PK_ProtectionCoverage", x => new { x.ProtectionPackageId, x.Id });
                _ = table.ForeignKey(
